//movements, walls, bullets, dash, audio, targets
use bevy::prelude::*;
...
fn main() {
    App::new()
        ...
        .add_systems(Startup, (setup_camera, load_assets, spawn_walls, spawn_player, spawn_target))
        .add_systems(Update, (
            player_movement, 
            dash_handler,
            projectile_movement, 
...
fn spawn_target(mut commands: Commands, player_query: Query<&Transform, With<Player>>) {
    use rand::Rng;
